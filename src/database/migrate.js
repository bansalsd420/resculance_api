...
CREATE TABLE IF NOT EXISTS ambulances (
  ...
  status ENUM('pending_approval', 'active', 'inactive', 'en_route', 'maintenance', 'suspended') DEFAULT 'pending_approval',
...
CREATE TABLE IF NOT EXISTS collaboration_requests (
  ...
  FOREIGN KEY (fleet_owner_id) REFERENCES organizations(id) ON DELETE CASCADE,
  FOREIGN KEY (ambulance_id) REFERENCES ambulances(id) ON DELETE CASCADE,
  FOREIGN KEY (requested_by) REFERENCES users(id) ON DELETE CASCADE,
  FOREIGN KEY (responded_by) REFERENCES users(id) ON DELETE SET NULL,
  INDEX idx_hospital (hospital_id),
  INDEX idx_fleet (fleet_owner_id),
  INDEX idx_ambulance (ambulance_id),
  INDEX idx_status (status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
