...
-- Generated: 2025-11-10T17:57:17.854Z
...
DROP TABLE IF EXISTS `ambulance_devices`;
...
DROP TABLE IF EXISTS `ambulance_user_mappings`;
...
DROP TABLE IF EXISTS `patient_session_data`;
