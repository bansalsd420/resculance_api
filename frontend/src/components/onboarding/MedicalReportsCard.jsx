...
export default function MedicalReportsCard({
  ...
  return (
    <Card className="p-2 h-[380px] flex flex-col overflow-hidden">
      ...
      {/* Tab Navigation */}
      <div className="flex gap-2 border-b border-border mb-1 flex-shrink-0">
        {['Notes', 'Meds', 'Files'].map((tab) => (
          ...
          >
            <span className="flex items-center gap-1">
              {tab === 'Notes' && <FileText className="w-3 h-3" />}
      ...
      <div className="flex-1 overflow-y-auto hidden-scrollbar">
        ...
        {activeTab === 'notes' && (
          <div className="space-y-1">
            {isActive && (
              <div className="p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-200 dark:border-blue-800">
          ...
          <div className="space-y-1.5">
            {isActive && (
              <motion.div 
                ...
                className="p-2 bg-green-50 dark:bg-green-900/20 rounded border border-green-200"
              >
            ...
            {loadingData ? (
              ...
              <div className="space-y-1">
                {sessionData.files.map((file) => (
                  <div 
                    key={file.id}
                    className="p-1.5 bg-white dark:bg-gray-800 rounded border-l-2 border-purple-500"
                  >
                    <div className="flex items-center gap-2 justify-between">
                      ...
                      <button
                        ...
                        className="p-1 bg-purple-100 hover:bg-purple-200 text-purple-600 rounded transition-colors"
                        title="Download"
                      >
